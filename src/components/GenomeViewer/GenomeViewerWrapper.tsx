...
import './GenomeViewerWrapper.css';

interface GenomeViewerWrapperProps {
...
const GenomeViewerWrapper: React.FC<GenomeViewerWrapperProps> = ({ 
    transcriptome,
    sequence,
    positionRange,
    width, 
    ...
    useEffect(() => {
        ...
        const genomeViewer = new GenomeViewer(svg, { 
            transcriptome,
            sequence,
            positionRange,
            width, 
            ...
            fontSize });
        genomeViewer.plot();
    }, [transcriptome, sequence, positionRange, width, height, fontSize]);
